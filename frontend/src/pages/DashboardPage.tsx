...
export function DashboardPage() {
  ...
  return (
    <section className="page-section dashboard-page">
      ...
      {!hasActivity && <div className="dashboard-empty"><strong>첫 학습을 시작해 보세요.</strong><span>Concept를 읽거나 Quiz를 풀면 이곳에 오늘의 활동과 진행률이 쌓입니다.</span><CanonicalBootstrapCard /></div>}
