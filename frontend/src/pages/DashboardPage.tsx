  ...
  return (
    <section className="page-section dashboard-page">
      ...
      <section className="dashboard-section">
        <div className="section-heading"><div><p className="eyebrow">활동 기록</p><h2>최근 365일 활동</h2></div><span className="helper-text">개념 읽기 + 문제 풀이</span></div>
      ...
      <div className="dashboard-two-column">
        <section className="dashboard-section">
          <div className="section-heading"><div><p className="eyebrow">최근 약점</p><h2>약점 Topic</h2></div><Link className="text-link" to="/wrong-notes" search={defaultWrongNoteSearch}>오답 노트 →</Link></div>
