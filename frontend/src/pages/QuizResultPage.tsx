    ...
    <section className="page-section quiz-page">
      ...
      <div className="quiz-result-actions">
        <div className="result-next-actions">
          <button className="primary-button" type="button" disabled={result.selfCheckPending > 0 || result.wrong + result.unanswered === 0 || retryMutation.isPending} onClick={() => retryMutation.mutate()}>{retryMutation.isPending ? '준비 중…' : '틀린 문항만 다시 풀기'}</button>
