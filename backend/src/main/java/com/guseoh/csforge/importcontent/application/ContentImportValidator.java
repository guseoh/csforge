...
public class ContentImportValidator {
    public List<NormalizedImportItem> validate(List<NormalizedImportItem> items) {
        ...
        Map<String, NormalizedImportItem> definitions = new java.util.HashMap<>();
        Map<String, NormalizedImportItem> topicSlugs = new java.util.HashMap<>();
        Map<String, NormalizedImportItem> conceptSlugs = new java.util.HashMap<>();
        ...
        for (NormalizedImportItem item : items) {
            ...
            if (item.kind() == ImportItemKind.TOPIC) validateNonNegative(item.displayOrder(), "displayOrder", errors);
