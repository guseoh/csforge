...
public interface ConceptRepository extends JpaRepository<Concept, Long> {
    ...
    @Query("""
            ...
            where c.status = com.guseoh.csforge.learning.domain.ContentStatus.PUBLISHED
              ...
              and a.id = :areaId
              and (
                    t.displayOrder < :topicOrder
                 or (t.displayOrder = :topicOrder and c.displayOrder < :conceptOrder)
                 or (t.displayOrder = :topicOrder and c.displayOrder = :conceptOrder and c.id < :conceptId)
              )
