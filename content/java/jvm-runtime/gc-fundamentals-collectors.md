...
**지연 시간**는 개별 요청이나 작업이 얼마나 오래 지연되는지를 봅니다. GC pause가 짧아야 하는 서비스에서는 꼬리 지연 시간(tail latency)에 민감할 수 있습니다.
...
무조건 하나가 더 좋다고 할 수 없습니다. Batch workload와 지연 시간-sensitive API 서버의 목표가 다를 수 있기 때문입니다.
