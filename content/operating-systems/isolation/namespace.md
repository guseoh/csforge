...
#### Q. Namespace와 cgroup의 차이를 설명해보세요.

Namespace는 process가 PID·mount·network 같은 resource를 어떻게 보고 이름 붙이는지 분리하고, cgroup은 process 집합의 CPU·memory·I/O 사용량을 accounting하거나 제한합니다. 보이는 세계와 사용할 수 있는 양을 분리해서 설명하면 좋습니다.
